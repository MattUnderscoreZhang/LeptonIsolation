...
# Test command:
#./build/x86_64-slc6-gcc62-opt/bin/ROOT_to_H5 /eos/user/m/mazhang/LepIso/ROOT/MUON5/mc16_13TeV.410470.PhPy8EG_A14_ttbar_hdamp258p75_nonallhad.deriv.DAOD_MUON5.e6337_e5984_s3126_r10201_r10210_p3584/DAOD_MUON5.14537525._000001.pool.root.1
cd ../..
...
do
    ...
    ./ROOTToH5/build/x86_64-centos7-gcc62-opt/bin/ROOT_to_H5 ${ROOT_path}/DAOD_MUON5.14537525._${padded_i}.pool.root.1
